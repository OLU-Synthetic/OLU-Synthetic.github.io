(() => {
  ...
  const WORKS = [
    ...
    },
    {
      ...
      href: "works/athamal/", // TODO: change later
...
/*
  // ==========================================================
  // PROCEDURAL AUDIO (NEW): warm ambient + subtle space
...
*/
  ...
  // ==========================================================
  // REFERENCE ONLY (OLD AUDIO) — DO NOT RUN
  // Copy/paste this block out if you ever want to revert.
  // ==========================================================
